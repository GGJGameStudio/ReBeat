        ...
        public static Mapset Parse(String mapsetJsonStr)
        {
            ...
            foreach (JSONNode node in levelsArray)
            {
                ...
                else if (type == "C")
                {
                    ...
                    LevelStartDirection dir;
                    switch (direction)
                    {
                        case "U": dir = LevelStartDirection.Up; break;
                        case "D": dir = LevelStartDirection.Down; break;
                        case "L": dir = LevelStartDirection.Left; break;
                        case "R": dir = LevelStartDirection.Right; break;
                        default: dir = LevelStartDirection.Up; break;
                    }
